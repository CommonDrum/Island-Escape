...
item(hardStick, none, 'You see a hard stick on the ground.', 'The stick is sturdy and may be useful for crafting.').
...
item(bottleOfPurifiedWater, none, 'The water is safe to drink.', '').
