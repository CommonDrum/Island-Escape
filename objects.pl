...
object(fire, _, 'You have created a fire!', 'The fire is warm and it feels nice being next to it.', []).
object(fireplace, _, 'You have created a fireplace!', 'Now you need to find something to set it on fire.', []).