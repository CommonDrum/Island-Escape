...
object(bush, jungleSouth, 'You see a bush with big leafs.', 'You strip the bush out of its leafs and gather some sticks.', [bigLeafs, hardStick,bigLeafs,hardStick]).
